...
public enum BridgeCommand: Equatable, Codable, Sendable {
    ...
    case processClaudeStatusLine(ClaudeStatusLinePayload)
    ...
    public init(from decoder: any Decoder) throws {
        ...
        case .processClaudeStatusLine:
            self = .processClaudeStatusLine(
                try container.decode(ClaudeStatusLinePayload.self, forKey: .claudeStatusLine)
            )
        }
    }
    ...
    public func encode(to encoder: any Encoder) throws {
        ...
        case let .processClaudeStatusLine(payload):
            try container.encode(CommandType.processClaudeStatusLine, forKey: .type)
            try container.encode(payload, forKey: .claudeStatusLine)
        }
    }
}
